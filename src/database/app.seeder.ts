...
\`\`\``);
  ...
  private buildReactNativeBaseCrudFiles(): PlaygroundTemplate['files'] {
    ...
    const tareasFormTsx = [
      ...
      '',
      '/**',
      ' * Formulario de alta/edición de una tarea — separado de la lista (TareasList).',
      ' * El padre (Tareas.tsx) le pasa `key={editing?.id ?? \'new\'}` para que el',
      ' * formulario reinicie sus campos al cambiar entre "agregar" y "editar".',
      ' */',
      'export function TareasForm({ editing, onSubmit }: TareasFormProps) {',
    ...
    const tareasListTsx = [
      ...
      '}',
      '',
      '/** Lista de tareas — separada del formulario (TareasForm). */',
      ...
      '          </Text>',
      '          <View style={styles.row}>',
      '            <Button label="Editar" small onPress={() => onEdit(item)} />',
      '            <Button label="Eliminar" small onPress={() => onDelete(item.id)} />',
      '          </View>',
      '        </View>',
      '      )}',
      '    />',
    ...
    const tareasTsx = [
      ...
      '',
      '/** Pantalla de Tareas: orquesta el formulario (TareasForm) y la lista (TareasList). */',
      ...
      '  return (',
      '    <Card title="Tareas">',
      "      <TareasForm key={editing?.id ?? 'new'} editing={editing} onSubmit={handleSubmit} />",
      '      <TareasList todos={todos} loading={loading} onEdit={setEditing} onDelete={handleDelete} />',
      '    </Card>',
      '  );',
      '}',
      '',
